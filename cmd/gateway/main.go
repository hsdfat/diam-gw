...
func main() {
	// Command line flags
	appListen := flag.String("app-listen", "0.0.0.0:3868", "Address to listen for application connections")
	...
	logger.Log.Infow("Listening for applications", "address", *appListen)
