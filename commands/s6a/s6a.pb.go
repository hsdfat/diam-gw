...
type UpdateLocationRequest struct {
	...
	OcSupportedFeatures         *OCSupportedFeatures           // Optional
	...
	GmlcAddress                 *models_base.Address           // Optional
	ActiveApn                   []*ActiveAPN                   // Optional
	EquivalentPlmnList          *EquivalentPLMNList            // Optional
	MmeNumberForMtSms           *models_base.OctetString       // Optional
	SmsRegisterRequest          *models_base.Enumerated        // Optional
	SgsMmeIdentity              *models_base.UTF8String        // Optional
	CoupledNodeDiameterId       *models_base.DiameterIdentity  // Optional
	AdjacentPlmns               *AdjacentPLMNs                 // Optional
	SupportedServices           *SupportedServices             // Optional
	Avp                         []models_base.OctetString      // Optional - WARNING: AVP code not defined, DO NOT USE
...
func (m *UpdateLocationRequest) Marshal() ([]byte, error) {
	...
	// Marshal OcSupportedFeatures (grouped)
	if m.OcSupportedFeatures != nil {
		if groupedData, err := m.OcSupportedFeatures.Marshal(); err == nil {
			buf.Write(marshalAVP(AVPCodeOCSUPPORTEDFEATURES, models_base.Grouped(groupedData), false, false))
		}
	}
	...
	if m.HomogeneousSupportImsVoice != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeHOMOGENEOUSSUPPORTOFIMSVOICEOVERPSSESSIONS, *m.HomogeneousSupportImsVoice, false, false, 10415))
	}

	// Marshal GmlcAddress (optional)
	if m.GmlcAddress != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeGMLCADDRESS, *m.GmlcAddress, true, false, 10415))
	}

	// Marshal ActiveApn (repeated, grouped)
	for _, v := range m.ActiveApn {
		if v != nil {
			if groupedData, err := v.Marshal(); err == nil {
				buf.Write(marshalAVPWithVendor(AVPCodeACTIVEAPN, models_base.Grouped(groupedData), true, false, 10415))
			}
		}
	}

	// Marshal EquivalentPlmnList (grouped)
	if m.EquivalentPlmnList != nil {
		if groupedData, err := m.EquivalentPlmnList.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeEQUIVALENTPLMNLIST, models_base.Grouped(groupedData), false, false, 10415))
		}
	}

	// Marshal MmeNumberForMtSms (optional)
	if m.MmeNumberForMtSms != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeMMENUMBERFORMTSMS, *m.MmeNumberForMtSms, false, false, 10415))
	}

	// Marshal SmsRegisterRequest (optional)
	if m.SmsRegisterRequest != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeSMSREGISTERREQUEST, *m.SmsRegisterRequest, false, false, 10415))
	}

	// Marshal SgsMmeIdentity (optional)
	if m.SgsMmeIdentity != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeSGSMMEIDENTITY, *m.SgsMmeIdentity, false, false, 10415))
	}

	// Marshal CoupledNodeDiameterId (optional)
	if m.CoupledNodeDiameterId != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeCOUPLEDNODEDIAMETERID, *m.CoupledNodeDiameterId, false, false, 10415))
	}

	// Marshal AdjacentPlmns (grouped)
	if m.AdjacentPlmns != nil {
		if groupedData, err := m.AdjacentPlmns.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeADJACENTPLMNS, models_base.Grouped(groupedData), false, false, 10415))
		}
	}

	// Marshal SupportedServices (grouped)
	if m.SupportedServices != nil {
		if groupedData, err := m.SupportedServices.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeSUPPORTEDSERVICES, models_base.Grouped(groupedData), false, false, 10415))
		}
	}
...
func (m *UpdateLocationRequest) Unmarshal(data []byte) error {
	...
	for len(avpData) > 0 {
		...
		case AVPCodeOCSUPPORTEDFEATURES: // OC-Supported-Features
			grouped := &OCSupportedFeatures{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.OcSupportedFeatures = grouped
			}
		...
		case AVPCodeHOMOGENEOUSSUPPORTOFIMSVOICEOVERPSSESSIONS: // Homogeneous-Support-of-IMS-Voice-Over-PS-Sessions
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeEnumerated(avpValue)
		...
		case AVPCodeACTIVEAPN: // Active-APN
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &ActiveAPN{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.ActiveApn = append(m.ActiveApn, grouped)
			}
		case AVPCodeEQUIVALENTPLMNLIST: // Equivalent-PLMN-List
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &EquivalentPLMNList{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.EquivalentPlmnList = grouped
			}
		case AVPCodeMMENUMBERFORMTSMS: // MME-Number-for-MT-SMS
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeOctetString(avpValue)
		...
		case AVPCodeSMSREGISTERREQUEST: // SMS-Register-Request
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeEnumerated(avpValue)
		...
		case AVPCodeSGSMMEIDENTITY: // SGs-MME-Identity
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeUTF8String(avpValue)
		...
		case AVPCodeCOUPLEDNODEDIAMETERID: // Coupled-Node-Diameter-ID
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeDiameterIdentity(avpValue)
			if err == nil {
				v := val.(models_base.DiameterIdentity)
				m.CoupledNodeDiameterId = &v
			}
		case AVPCodeADJACENTPLMNS: // Adjacent-PLMNs
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &AdjacentPLMNs{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.AdjacentPlmns = grouped
			}
		case AVPCodeSUPPORTEDSERVICES: // Supported-Services
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &SupportedServices{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.SupportedServices = grouped
			}
...
func (m *UpdateLocationAnswer) Marshal() ([]byte, error) {
	...
	// Marshal OcOlr (grouped)
	if m.OcOlr != nil {
		if groupedData, err := m.OcOlr.Marshal(); err == nil {
			buf.Write(marshalAVP(AVPCodeOCOLR, models_base.Grouped(groupedData), false, false))
		}
	}

	// Marshal Load (repeated, grouped)
	for _, v := range m.Load {
		if v != nil {
			if groupedData, err := v.Marshal(); err == nil {
				buf.Write(marshalAVP(AVPCodeLOAD, models_base.Grouped(groupedData), false, false))
			}
		}
	}
	...
	for _, v := range m.ResetId {
		buf.Write(marshalAVPWithVendor(AVPCodeRESETID, v, true, false, 10415))
	}
...
func (m *UpdateLocationAnswer) Unmarshal(data []byte) error {
	...
	for len(avpData) > 0 {
		...
		case AVPCodeOCOLR: // OC-OLR
			grouped := &OCOLR{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.OcOlr = grouped
			}
		case AVPCodeLOAD: // Load
			grouped := &Load{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.Load = append(m.Load, grouped)
			}
		case AVPCodeSUPPORTEDFEATURES: // Supported-Features
			if vendorID != 10415 {
				break // Vendor ID mismatch
...
func (m *AuthenticationInformationAnswer) Marshal() ([]byte, error) {
	...
	if m.UeUsageType != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeUEUSAGETYPE, *m.UeUsageType, false, false, 10415))
	}
...
type InsertSubscriberDataAnswer struct {
	...
	ResultCode                      *models_base.Unsigned32        // Optional
	ExperimentalResult              *ExperimentalResult            // Optional
	ImsVoiceOverPsSessionsSupported *models_base.Enumerated        // Optional
	...
	EpsUserState                    *EPSUserState                  // Optional
	EpsLocationInformation          *EPSLocationInformation        // Optional
	LocalTimeZone                   *LocalTimeZone                 // Optional
	SupportedServices               *SupportedServices             // Optional
	MonitoringEventReport           []*MonitoringEventReport       // Optional
	MonitoringEventConfigStatus     []*MonitoringEventConfigStatus // Optional
	Avp                             []models_base.OctetString      // Optional - WARNING: AVP code not defined, DO NOT USE
	FailedAvp                       *FailedAVP                     // Optional
	ProxyInfo                       []*ProxyInfo                   // Optional
	RouteRecord                     []models_base.DiameterIdentity // Optional
...
func (m *InsertSubscriberDataAnswer) Marshal() ([]byte, error) {
	...
	if m.ImsVoiceOverPsSessionsSupported != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeIMSVOICEOVERPSSESSIONSSUPPORTED, *m.ImsVoiceOverPsSessionsSupported, false, false, 10415))
	}

	// Marshal LastUeActivityTime (optional)
	if m.LastUeActivityTime != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeLASTUEACTIVITYTIME, *m.LastUeActivityTime, false, false, 10415))
	}
	...
	// Marshal EpsUserState (grouped)
	if m.EpsUserState != nil {
		if groupedData, err := m.EpsUserState.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeEPSUSERSTATE, models_base.Grouped(groupedData), false, false, 10415))
		}
	}

	// Marshal EpsLocationInformation (grouped)
	if m.EpsLocationInformation != nil {
		if groupedData, err := m.EpsLocationInformation.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeEPSLOCATIONINFORMATION, models_base.Grouped(groupedData), false, false, 10415))
		}
	}

	// Marshal LocalTimeZone (grouped)
	if m.LocalTimeZone != nil {
		if groupedData, err := m.LocalTimeZone.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeLOCALTIMEZONE, models_base.Grouped(groupedData), false, false, 10415))
		}
	}
	...
	// Marshal MonitoringEventReport (repeated, grouped)
	for _, v := range m.MonitoringEventReport {
		if v != nil {
			if groupedData, err := v.Marshal(); err == nil {
				buf.Write(marshalAVPWithVendor(AVPCodeMONITORINGEVENTREPORT, models_base.Grouped(groupedData), false, false, 10415))
			}
		}
	}

	// Marshal MonitoringEventConfigStatus (repeated, grouped)
	for _, v := range m.MonitoringEventConfigStatus {
		if v != nil {
			if groupedData, err := v.Marshal(); err == nil {
				buf.Write(marshalAVPWithVendor(AVPCodeMONITORINGEVENTCONFIGSTATUS, models_base.Grouped(groupedData), false, false, 10415))
			}
		}
	}
...
func (m *InsertSubscriberDataAnswer) Unmarshal(data []byte) error {
	...
	for len(avpData) > 0 {
		...
		case AVPCodeIMSVOICEOVERPSSESSIONSSUPPORTED: // IMS-Voice-Over-PS-Sessions-Supported
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeEnumerated(avpValue)
			if err == nil {
				v := val.(models_base.Enumerated)
				m.ImsVoiceOverPsSessionsSupported = &v
			}
		case AVPCodeLASTUEACTIVITYTIME: // Last-UE-Activity-Time
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeTime(avpValue)
		...
		case AVPCodeEPSUSERSTATE: // EPS-User-State
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &EPSUserState{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.EpsUserState = grouped
			}
		case AVPCodeEPSLOCATIONINFORMATION: // EPS-Location-Information
			if vendorID != 10415 {
				break // Vendor ID mismatch
			...
			grouped := &EPSLocationInformation{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.EpsLocationInformation = grouped
			}
		case AVPCodeLOCALTIMEZONE: // Local-Time-Zone
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &LocalTimeZone{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.LocalTimeZone = grouped
			}
		case AVPCodeSUPPORTEDSERVICES: // Supported-Services
			if vendorID != 10415 {
				break // Vendor ID mismatch
		...
		case AVPCodeMONITORINGEVENTREPORT: // Monitoring-Event-Report
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &MonitoringEventReport{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.MonitoringEventReport = append(m.MonitoringEventReport, grouped)
			}
		case AVPCodeMONITORINGEVENTCONFIGSTATUS: // Monitoring-Event-Config-Status
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &MonitoringEventConfigStatus{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.MonitoringEventConfigStatus = append(m.MonitoringEventConfigStatus, grouped)
			}
		// case 0: // AVP (AVP code not defined)
		case AVPCodeFAILEDAVP: // Failed-AVP
			grouped := &FailedAVP{}
...
type DeleteSubscriberDataRequest struct {
	...
	TsCode                      []models_base.OctetString      // Optional
	SsCode                      []models_base.OctetString      // Optional
	EdrxRelatedRat              *models_base.Unsigned32        // Optional
	ExternalIdentifier          []models_base.UTF8String       // Optional
	Avp                         []models_base.OctetString      // Optional - WARNING: AVP code not defined, DO NOT USE
	ProxyInfo                   []*ProxyInfo                   // Optional
	RouteRecord                 []models_base.DiameterIdentity // Optional
...
func (m *DeleteSubscriberDataRequest) Marshal() ([]byte, error) {
	...
	// Marshal ScefId (optional)
	if m.ScefId != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeSCEFID, *m.ScefId, false, false, 10415))
	}
	...
	if m.TraceReference != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeTRACEREFERENCE, *m.TraceReference, true, false, 10415))
	}
	...
	if m.EdrxRelatedRat != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeEDRXRELATEDRAT, *m.EdrxRelatedRat, false, false, 10415))
	}

	// Marshal ExternalIdentifier (repeated)
	for _, v := range m.ExternalIdentifier {
		buf.Write(marshalAVPWithVendor(AVPCodeEXTERNALIDENTIFIER, v, false, false, 10415))
	}
...
func (m *DeleteSubscriberDataRequest) Unmarshal(data []byte) error {
	...
	for len(avpData) > 0 {
		...
		case AVPCodeEDRXRELATEDRAT: // eDRX-Related-RAT
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeUnsigned32(avpValue)
		...
		case AVPCodeEXTERNALIDENTIFIER: // External-Identifier
			...
			val, err := models_base.DecodeUTF8String(avpValue)
			if err == nil {
				m.ExternalIdentifier = append(m.ExternalIdentifier, val.(models_base.UTF8String))
			}
		// case 0: // AVP (AVP code not defined)
		case AVPCodePROXYINFO: // Proxy-Info
			grouped := &ProxyInfo{}
...
type ResetRequest struct {
	...
	ResetId                     []models_base.OctetString      // Optional
	SubscriptionData            *SubscriptionData              // Optional
	SubscriptionDataDeletion    *SubscriptionDataDeletion      // Optional
	Avp                         []models_base.OctetString      // Optional - WARNING: AVP code not defined, DO NOT USE
	ProxyInfo                   []*ProxyInfo                   // Optional
	RouteRecord                 []models_base.DiameterIdentity // Optional
}
...
func (m *ResetRequest) Marshal() ([]byte, error) {
	...
	for _, v := range m.UserId {
		buf.Write(marshalAVPWithVendor(AVPCodeUSERID, v, false, false, 10415))
	}
	...
	// Marshal SubscriptionDataDeletion (grouped)
	if m.SubscriptionDataDeletion != nil {
		if groupedData, err := m.SubscriptionDataDeletion.Marshal(); err == nil {
			buf.Write(marshalAVPWithVendor(AVPCodeSUBSCRIPTIONDATADELETION, models_base.Grouped(groupedData), true, false, 10415))
		}
	}
...
func (m *ResetRequest) Unmarshal(data []byte) error {
	...
	for len(avpData) > 0 {
		...
		case AVPCodeSUBSCRIPTIONDATADELETION: // Subscription-Data-Deletion
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			grouped := &SubscriptionDataDeletion{}
			if err := grouped.Unmarshal(avpValue); err == nil {
				m.SubscriptionDataDeletion = grouped
			}
		// case 0: // AVP (AVP code not defined)
		case AVPCodePROXYINFO: // Proxy-Info
			grouped := &ProxyInfo{}
...
type NotifyRequest struct {
	...
	HomogeneousSupportImsVoice  *models_base.Enumerated        // Optional
	MaximumUeAvailabilityTime   *models_base.Time              // Optional
	MonitoringEventConfigStatus []*MonitoringEventConfigStatus // Optional
	EmergencyServices           *models_base.Unsigned32        // Optional
	Avp                         []models_base.OctetString      // Optional - WARNING: AVP code not defined, DO NOT USE
	ProxyInfo                   []*ProxyInfo                   // Optional
	RouteRecord                 []models_base.DiameterIdentity // Optional
}
...
func (m *NotifyRequest) Marshal() ([]byte, error) {
	...
	if m.MaximumUeAvailabilityTime != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeMAXIMUMUEAVAILABILITYTIME, *m.MaximumUeAvailabilityTime, false, false, 10415))
	}
	...
	if m.EmergencyServices != nil {
		buf.Write(marshalAVPWithVendor(AVPCodeEMERGENCYSERVICES, *m.EmergencyServices, false, false, 10415))
	}
...
func (m *NotifyRequest) Unmarshal(data []byte) error {
	...
	for len(avpData) > 0 {
		...
		case AVPCodeMAXIMUMUEAVAILABILITYTIME: // Maximum-UE-Availability-Time
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeTime(avpValue)
		...
		case AVPCodeEMERGENCYSERVICES: // Emergency-Services
			if vendorID != 10415 {
				break // Vendor ID mismatch
			}
			val, err := models_base.DecodeUnsigned32(avpValue)
